# Generated by Django 3.1.3 on 2021-12-27 17:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(models.Q(models.Q(('is_income', True), ('is_expense', False), ('is_equity', False)), models.Q(('is_income', False), ('is_expense', True), ('is_equity', False)), models.Q(('is_income', False), ('is_expense', False), ('is_equity', True)), _connector='OR')), name='either_income_expense_or_equity'),
        ),
        migrations.AddConstraint(
            model_name='accountkinds',
            constraint=models.CheckConstraint(check=models.Q(('is_passive_income', False), ('is_income', True), _connector='OR'), name='passive_income_is_also_income'),
        ),
        migrations.AddConstraint(
            model_name='accountkinds',
            constraint=models.CheckConstraint(check=models.Q(('is_work_income', False), ('is_income', True), _connector='OR'), name='work_income_is_also_income'),
        ),
        migrations.AddConstraint(
            model_name='accountkinds',
            constraint=models.CheckConstraint(check=models.Q(('is_liquid', False), ('is_equity', True), _connector='OR'), name='is_liquid_is_only_for_equity'),
        ),
        migrations.AddConstraint(
            model_name='accountkinds',
