...
use crate::connections::{Database, SqliteConnect, PooledSqlite};
...
use diesel::sql_types::{Date, Float, Integer, Nullable, Text};
...
struct KmmKeyValue {
    #[diesel(sql_type = Text)] // Could be NULL in schema, but not in practice
    #[diesel(column_name = kvpId)]
    id: String,

    #[diesel(sql_type = Text)]
    #[diesel(column_name = kvpType)]
    typ: String,

    #[diesel(sql_type = Text)]
    #[diesel(column_name = kvpKey)]
    key: String,

    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = kvpData)]
    data: Option<String>,
}

static GET_KMM_KEY_VALUE_FOR_ACCOUNTS: &str = "SELECT kmmKeyValuePairs.*
...
struct KmmInstitutions {
    ...
    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = routingCode)]
    ...
    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = addressStreet)]
    address_street: Option<String>,

    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = addressZipcode)]
    address_zipcode: Option<String>,

    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = addressCity)]
...
struct KmmPrices {
    #[diesel(sql_type = Text)]
    #[diesel(column_name = fromId)]
    from_id: String,

    #[diesel(sql_type = Text)]
    #[diesel(column_name = toId)]
    to_id: String,

    #[diesel(sql_type = Date)]
    #[diesel(column_name = priceDate)]
    ...
    #[diesel(column_name = priceFormatted)]
    _price_formatted: f32,

    #[diesel(sql_type = Text)]
    #[diesel(column_name = priceSource)]
    price_source: String,
}
...
struct KmmCurrencies {
    ...
    #[diesel(sql_type = Text)]
    #[diesel(column_name = typeString)]
    type_string: String,

    // Unicode code point for the symbol
    #[diesel(sql_type = Integer)]
    #[diesel(column_name = symbol1)]
    _symbol1: i32,

    #[diesel(sql_type = Text)]
    #[diesel(column_name = symbolString)]
    symbol_string: String,

    #[diesel(sql_type = Integer)]
    #[diesel(column_name = symbol2)]
    _symbol2: i32,

    #[diesel(sql_type = Integer)]
    #[diesel(column_name = symbol3)]
    _symbol3: i32,

    #[diesel(sql_type = Integer)]
    #[diesel(column_name = smallestCashFraction)]
    _smallest_cash_fraction: i32,
    // Smallest fraction of the currency used for cash accounts
    #[diesel(sql_type = Integer)]
    #[diesel(column_name = smallestAccountFraction)]
    smallest_account_fraction: i32,
    // Smallest fraction of the currency used for bank accounts
    #[diesel(sql_type = Integer)]
    #[diesel(column_name = pricePrecision)]
    price_precision: i32,
...
struct KmmSecurities {
    ...
    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = tradingMarket)]
    _trading_market: Option<String>,

    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = tradingCurrency)]
    _trading_currency: Option<String>,

    #[diesel(sql_type = Integer)]
    #[diesel(column_name = roundingMethod)]
...
struct KmmPayees {
    ...
    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = addressState)]
    _address_state: Option<String>,

    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = telephone)]
    _telephone: Option<String>,

    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = notes)]
    _notes: Option<String>,

    #[diesel(sql_type = Nullable<Integer>)]
    #[diesel(column_name = defaultAccountId)]
    _default_account_id: Option<AccountId>,

    #[diesel(sql_type = Nullable<Integer>)]
    #[diesel(column_name = matchData)]
    _match_data: Option<i32>,

    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = matchIgnoreCase)]
    _match_ignore_case: Option<String>,

    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = matchKeys)]
...
struct KmmAccounts {
    ...
    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = institutionId)]
    ...
    #[diesel(column_name = lastReconciled)]
    last_reconciled: Option<NaiveDate>,

    #[diesel(sql_type = Nullable<Date>)]
    #[diesel(column_name = lastModified)]
    _last_modified: Option<NaiveDate>,

    #[diesel(sql_type = Nullable<Date>)]
    #[diesel(column_name = openingDate)]
    opening_date: Option<NaiveDate>,

    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = accountNumber)]
    account_number: Option<String>,

    #[diesel(sql_type = Text)]
    #[diesel(column_name = accountType)]
    _account_type: String,

    #[diesel(sql_type = Text)]
    #[diesel(column_name = accountTypeString)]
    account_type_string: String,

    #[diesel(sql_type = Text)]
    #[diesel(column_name = isStockAccount)]
    ...
    #[diesel(sql_type = Text)]
    #[diesel(column_name = currencyId)]
    currency_id: String,

    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = balance)]
    _balance: Option<String>,

    #[diesel(sql_type = Float)]
    #[diesel(column_name = balanceFormatted)]
    _balance_formatted: f32,

    #[diesel(sql_type = Float)]
    #[diesel(column_name = transactionCount)]
...
struct KmmTransactionsAndSchedule {
    ...
    #[diesel(sql_type = Nullable<Integer>)]
    #[diesel(column_name = occurence)]
    occurrence: Option<i32>, //  number of the repeating occurrence

    #[diesel(sql_type = Nullable<Integer>)]
    #[diesel(column_name = occurenceMultiplier)]
    ...
    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = lastDayInMonth)]
    last_day_in_month: Option<String>,

    #[diesel(sql_type = Nullable<Integer>)]
    #[diesel(column_name = weekendOption)]
    weekend_option: Option<i32>,

    #[diesel(sql_type = Nullable<Date>)]
    #[diesel(column_name = lastPayment)]
...
struct KmmSplits {
    ...
    #[diesel(sql_type = Text)]
    #[diesel(column_name = txType)]
    _tx_type: String,

    #[diesel(sql_type = Integer)]
    #[diesel(column_name = splitId)]
    _id: i32,

    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = payeeId)]
    payee_id: Option<String>,

    #[diesel(sql_type = Nullable<Date>)]
    #[diesel(column_name = reconcileDate)]
    reconcile_date: Option<chrono::NaiveDate>,

    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = action)]
    action: Option<String>,

    #[diesel(sql_type = Integer)]
    #[diesel(column_name = reconcileFlag)]
    reconcile_flag: i32,
    ...
    #[diesel(sql_type = Text)]
    #[diesel(column_name = valueFormatted)]
    _value_formatted: String,

    #[diesel(sql_type = Text)]
    #[diesel(column_name = shares)]
    shares: String,

    #[diesel(sql_type = Text)]
    #[diesel(column_name = sharesFormatted)]
    ...
    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = costCenterId)]
    _cost_center_id: Option<String>,

    #[diesel(sql_type = Nullable<Text>)]
    #[diesel(column_name = checkNumber)]
...
impl KmyFile {
    ...
    pub fn import_key_values(&mut self, kmy: &mut SqliteConnection) -> AlrResult<()> {
        let kv = sql_query(GET_KMM_KEY_VALUE_FOR_ACCOUNTS).load::<KmmKeyValue>(kmy)?;
        ...
        for row in kv.into_iter() {
            match row.key.as_str() {
                ...
                "OpeningBalanceAccount" => {
                    if let Some(d) = row.data {
                        if d.to_lowercase() == "yes" {
                            self.account_has_opening_balances.insert(row.id);
                        }
                    }
                }
    ...
    pub fn create_account_kinds(&mut self, target: &mut PooledSqlite) -> AlrResult<()> {
        ...
        let existing: Vec<AccountKind> =
            sql_query("SELECT * FROM alr_account_kinds").load(target)?;
        for k in existing {
    ...
    pub fn import_institutions(
        &mut self,
        kmy: &mut SqliteConnection,
        target: &mut PooledSqlite,
    ) -> AlrResult<()> {
    ...
    pub fn import_currencies(
        ...
        for c in currencies.into_iter() {
            ...
            self.qty_scales
                .insert(c.iso_code.clone(), c.smallest_account_fraction);
    ...
    pub fn import_securities(
        ...
        for c in securities.into_iter() {
            let kind = match c.type_string.as_str() {
                ...
                e => return Err(format!("Invalid security type {}", e).into()),
            };
            ...
            self.qty_scales
                .insert(c.id.clone(), c.smallest_account_fraction);
    ...
    pub fn import_payees(
        ...
        for p in payees {
            self.payees.insert(p.id, Payee::create(target, p.name)?);
        }
        Ok(())
    }
    ...
    pub fn import_accounts(
        ...
        for a in diesel::sql_query(q).load::<KmmAccounts>(kmy)? {
            ...
            let mut acc = Account::new(AccountConfig {
                name: &a.account_name,
                commodity_scu: *self
                    .qty_scales
                    .get(&a.currency_id)
                    .unwrap_or_else(|| panic!("No qty_scales for {}", a.currency_id)),
                commodity_id: self.commodities.get(&a.currency_id).unwrap().id,
                kind_id: akind,
                ...
                last_reconciled: a.last_reconciled.and_then(|r| r.and_hms_opt(0, 0, 0)),
    ...
    pub fn import_prices(
        ...
        for price in prices {
            let origin = match self.commodities.get(&price.from_id) {
                None => return Err(format!("No matching commodity {}", price.from_id).into()),
                Some(orig) => orig,
            };

            let dest = match self.commodities.get(&price.to_id) {
                None => return Err(format!("No matching commodity {}", price.to_id).into()),
                Some(orig) => orig,
            };
            ...
            let date = match price.price_date.and_hms_opt(0, 0, 0) {
                Some(d) => d,
                None => {
                    return Err(format!("Could not parse date {}", price.price_date).into());
                }
            };
            let source = price_sources
                .get(&price.price_source)
                .ok_or(format!("Invalid price source {}", price.price_source))?;

            match p {
                Some(val) => {
                    Price::create(target, origin.id, dest.id, date, val as u64, source.id)?;
                }
                None => {
                    return Err(format!(
                        "Could not parse price {} for commodity {}",
                        price.price, origin.id
                    )
                    .into());
                }
            };
    ...
    pub fn import_transactions(
        ...
        for sp in sql_query(q).load::<KmmSplits>(kmy)? {
            ...
            let mut qty = parse_str(&sp.shares).ok_or("Could not parse qty")?;
            let currency = tx_currencies[&sp.transaction_id];
            let price = sp.price.as_ref().map(|p| parse_str(p).unwrap_or_default());
            let value = parse_str(&sp.value).ok_or("Could not parse value")?;
            let mut extra_msg: String = Default::default();
            let mut ratio: Decimal = Decimal::ONE;

            match (sp.action.as_deref(), price) {
                (Some("Dividend"), _) | (Some("IntIncome"), _) => {
                ...
                (Some("Add"), _) => {
                    ...
                    extra_msg.push_str(if qty.is_sign_positive() {
                        "Add shares"
                    } else {
                        "Remove shared"
                    });
                ...
                (Some("Buy"), Some(p)) => {
                    debug_assert!(
                        (value - qty * p).abs() < Decimal::ONE / Decimal::from(100),
                        "{} - {} < {}  (scale={} {}, split={:?})",
                        value,
                        qty * p,
                        Decimal::ONE / Decimal::from(acc.commodity_scu),
                        acc.commodity_scu,
                        currency.price_scale,
                        sp
                    );
                    extra_msg.push_str(if qty.is_sign_positive() {
                        "Buy shares"
            ...
            s.set_payee(
                sp.payee_id.and_then(|pi| self.payees.get(&pi)), // payee_id
            );
            s.set_reconcile(
                reconcile, // reconcile
...
pub fn import(target: &Path, source: &Path) -> AlrResult<()> {
    ...
    let mut kmy = match SqliteConnection::establish(&s) {
        Ok(k) => k,
    ...
    if let Err(e) = db.create_file(target) {
        return Err(format!("Error creating {}, {}", target.display(), e).into());
    }
    let mut connection: SqliteConnect = db.get()?;

    connection
        .0
        .transaction::<(), crate::errors::AlrError, _>(|conn| {
            let mut file = KmyFile::default();
            file.import_key_values(&mut kmy)
                .map_err(|e| format!("{} while importing key-values", e))?;
            file.create_account_kinds(conn)?;
            let price_sources = file.import_price_sources(&mut kmy, conn)?;
            file.import_institutions(&mut kmy, conn)
                .map_err(|e| format!("{} while importing institutions", e))?;
            file.import_currencies(&mut kmy, conn)
                .map_err(|e| format!("{} while importing currencies", e))?;
            file.import_securities(&mut kmy, conn)
                .map_err(|e| format!("{} while importing securities", e))?;
            file.import_payees(&mut kmy, conn)
                .map_err(|e| format!("{} while importing payees", e))?;
            file.import_accounts(&mut kmy, conn)
                .map_err(|e| format!("{} while importing accounts", e))?;
            file.import_prices(&mut kmy, conn, &price_sources)
                .map_err(|e| format!("{} while importing prices", e))?;
            file.import_transactions(&mut kmy, conn)
